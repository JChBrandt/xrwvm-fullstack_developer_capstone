...
def initiate():
    ...
    car_model_data = [
      ...
      {"name":"A-Class", "modeltype":"SUV", "year": 2023, "maker":car_make_instances[1]},
      {"name":"C-Class", "modeltype":"SUV", "year": 2023, "maker":car_make_instances[1]},
      {"name":"E-Class", "modeltype":"SUV", "year": 2023, "maker":car_make_instances[1]},
      {"name":"A4", "modeltype":"SUV", "year": 2023, "maker":car_make_instances[2]},
      {"name":"A5", "modeltype":"SUV", "year": 2023, "maker":car_make_instances[2]},
      {"name":"A6", "modeltype":"SUV", "year": 2023, "maker":car_make_instances[2]},
    ...
    for data in car_model_data:
            CarModel.objects.create(name=data['name'], maker=data['maker'], modeltype=data['modeltype'], year=data['year'])